...
@section('content')
    ...
    <div class ="container">
        <div class ="row">
            ...
            <form action="/Jeff/public/posts/{{$post->id}}/edit" method="post">

                <div class="form-group">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                    <label for="taskTitle">Task Title</label>
                    <input type="text" class="form-control" id="taskTitle" name="body" value="{{$post->title}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="taskTitle" name="body" value="{{$post->body}}">
                </div>
            ...
            <form action="/Jeff/public/posts/{{$post->id}}/delete" method="post">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
        ...
        <div class ="col-md-5 col-md-offset-2">
            ...
            <form action="/Jeff/public/posts/{{$post->id}}/comments" method="post">
                {{ csrf_field() }}
                <div class="form-group">
